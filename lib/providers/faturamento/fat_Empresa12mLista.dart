...
class FatEmpresa12mLista with ChangeNotifier {
  final String _token;
  //final String _senha;
  ...
  FatEmpresa12mLista(this._token, this._empresas);
  ...
  Future<void> loadEmpresas(context, empresa,dataIni,dataFim) async {
    ...
    final response = await http.get(
        Uri.parse(            
            'http://biosat.dyndns.org:8084/REST/api/biosat/v1/FaturamentoEmpresas/Fat12Meses/$dataIni/$dataFim'),
        headers: {
