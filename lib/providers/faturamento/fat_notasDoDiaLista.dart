...
class FatNotasDoDiaLista with ChangeNotifier {
  final String _token;
  //final String _senha;
  //final String _empresa;
  List<FaturamentoNotasDoDia> _notaFiscal = [];
  List<dynamic> data = [];
  Map<String, dynamic> data0 = {};
  int n = 0;

  List<FaturamentoNotasDoDia> get notaFiscal => [..._notaFiscal];
 

  FatNotasDoDiaLista(this._token, this._notaFiscal);
  ...
  Future<void> loadNotasDoDia(context, empresa,dataIni,dataFim) async {
    List<FaturamentoNotasDoDia> notaFiscal = [];
    _notaFiscal.clear();
    notaFiscal.clear();
    ...
    final response = await http.get(
        Uri.parse(            
            'http://biosat.dyndns.org:8084/REST/api/biosat/v1/FaturamentoEmpresas/NfsDoDia/$empresa/$dataIni/$dataFim'),
        headers: {
